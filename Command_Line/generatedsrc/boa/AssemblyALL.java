...
public class AssemblyALL extends boa.runtime.BoaRunner {
	/** {@inheritDoc} */
	@Override
	public org.apache.hadoop.mapreduce.Job job(final org.apache.hadoop.fs.Path[] ins, final org.apache.hadoop.fs.Path out, final boolean robust) throws java.io.IOException {
		...
		job.setJobName("AssemblyALL: " + out);

		job.setJarByClass(AssemblyALLBoaMapper.class);

		job.setMapperClass(AssemblyALLBoaMapper.class);
		job.setCombinerClass(AssemblyALLBoaCombiner.class);
		job.setReducerClass(AssemblyALLBoaReducer.class);
	...
	org.apache.hadoop.util.ToolRunner.run(new AssemblyALL(), args);
		//System.exit();
	}
	...
	static class AssemblyALLBoaMapper extends boa.runtime.BoaMapper {
	...
	static class AssemblyALLBoaCombiner extends boa.runtime.BoaCombiner {
		public AssemblyALLBoaCombiner() {
			super();
	...
	static class AssemblyALLBoaReducer extends boa.runtime.BoaReducer {
		public AssemblyALLBoaReducer() {
			super();
	...
	public org.apache.hadoop.mapreduce.Mapper getMapper() {
		return new AssemblyALLBoaMapper();
	}

	@Override
	public boa.runtime.BoaCombiner getCombiner() {
		return new AssemblyALLBoaCombiner();
	}

	@Override
	public boa.runtime.BoaReducer getReducer() {
		return new AssemblyALLBoaReducer();
	}
}