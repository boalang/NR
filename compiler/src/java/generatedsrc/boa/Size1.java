...
public class Size1 extends boa.runtime.BoaRunner {
	/** {@inheritDoc} */
	@Override
	public org.apache.hadoop.mapreduce.Job job(final org.apache.hadoop.fs.Path[] ins, final org.apache.hadoop.fs.Path out, final boolean robust) throws java.io.IOException {
		...
		job.setJobName("Size1: " + out);

		job.setJarByClass(Size1BoaMapper.class);

		job.setMapperClass(Size1BoaMapper.class);
		job.setCombinerClass(Size1BoaCombiner.class);
		job.setReducerClass(Size1BoaReducer.class);
	...
	org.apache.hadoop.util.ToolRunner.run(new Size1(), args);
		//System.exit();
	}
	...
	static class Size1BoaMapper extends boa.runtime.BoaMapper {
		private static class Job0 implements BoaJob {
			...
			public void map(final boa.types.Nr2.Sequence _input, final org.apache.hadoop.mapreduce.Mapper<org.apache.hadoop.io.Text, org.apache.hadoop.io.BytesWritable, boa.io.EmitKey, boa.io.EmitValue>.Context context) throws Exception {
				...
				for (long ___i = 0; ___i < ___s.getClusterList().size(); ___i++)
				{
					...
					{
						{
							context.write(new boa.io.EmitKey("[" + (___s.getClusterList().get((int)(___i)).getSimilarity()) + "]" + "[" + (___s.getClusterList().get((int)(___i)).getCid()) + "]", "countAll", 0), new boa.io.EmitValue(1l));
						}
					}
				}
	...
	static class Size1BoaCombiner extends boa.runtime.BoaCombiner {
		public Size1BoaCombiner() {
			super();
	...
	static class Size1BoaReducer extends boa.runtime.BoaReducer {
		public Size1BoaReducer() {
			super();
