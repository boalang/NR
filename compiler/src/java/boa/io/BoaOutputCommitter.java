...
public class BoaOutputCommitter extends FileOutputCommitter {
	...
	private final static String url = "jdbc:mysql://localhost:3306/drupal";
	private final static String user = "drupal";
	private final static String password = "drupal";
	...
	private void updateStatus(final String error, final int jobId) {
		...
		try {
			...
			try {
				...
				PrintWriter writer = new PrintWriter("BoaOutputcomitter.txt", "UTF-8");
