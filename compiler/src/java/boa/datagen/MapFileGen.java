...
public class MapFileGen {
	private static String SEQ_FILE_PATH = null;
	...
	public static void main(String[] args) throws Exception {
		...
		String seqFile_path= args[0];
		SEQ_FILE_PATH = Properties.getProperty("seq.file.path",seqFile_path);
		...
		if (fs.isFile(path)) {
			if (path.getName().equals(MapFile.DATA_FILE_NAME)) {
				...
				long ret = MapFile.fix(fs, dir, Text.class, BytesWritable.class, false, conf);
